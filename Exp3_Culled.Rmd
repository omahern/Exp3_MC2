...
```{r}
df_l2ft=read.csv('data_greaterthan0.1.csv',header=T,row.names=1)
...
## Fig. 1: State Data
### Three Panels
```{r fig1-threepanels, fig.height=8,fig.width=8}
data=read.csv(file="/Users/ahern/R/trophic_cascades/mc2/m2_do_02_edit.csv",header=T)
...
```{r fig1-twopanels, fig.height=8,fig.width=8}
read=read.csv(file="/Users/ahern/R/trophic_cascades/mc2/states_gluc.csv",
              header=T)
glucose=read$Glucose_um
time_glucose=read$Time
...
```{r figure-2-pcoas, fig.height=4, fig.width=10}
